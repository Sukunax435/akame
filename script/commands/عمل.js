...
var rddd1 = ['شخص مميز','مستفيد','غريب','شخص عمره 23 عامًا و أحمق','غريب','راعي','رجل  يبلغ من العمر 92 عاما ','صبي عمره21 عامًا','شرطي','شخص سكير','رجل اعمال','رجل دولة','رجل سياسي']; //random công việc khi đào đá
var work6 = rddd1[Math.floor(Math.random() * rddd1.length)];
  
var rddd2 = ['شخص مميز','مستفيد','غريب','شخص عمره 23 عامًا و أحمق','غريب','راعي','رجل  يبلغ من العمره 92 عاما ','رجل عمره 22 عام رجل متعب','شرطي','رجل عجوز','رجل اعمال','رجل دولة','رجل سياسي']; //random công việc khi đào đá
