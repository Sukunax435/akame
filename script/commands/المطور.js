...
module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "S H A D Y",
  description: "مالك بوت والمعلومات",
...
module.exports.run = async function ({ api, event, args, Users, permssion, getText ,Threads}) {
  ...
  const listNDH = NDH || config.NDH ||  [];
  {
    ...
    var link = [
      "https://i.imgur.com/8Fueujt.jpg","https://i.imgur.com/8Fueujt.jpg","https://i.imgur.com/8Fueujt.jpg","https://i.imgur.com/8Fueujt.jpg",
    ];
...
\nhttps://www.facebook.com/profile.php?id=61550232547706\n_______________________`, attachment: fs.createReadStream(__dirname + "/cache/kensu.jpg"), }, event.threadID, () => fs.unlinkSync(__dirname + "/cache/kensu.jpg"));
